...
from helper import load_mnist, split_data, normalise_input
...
X, y = load_mnist(device="cpu", size=1000, as_vector=True)
...
model = mlpe.MLPExtractor(no_features, [], 10).to(device)
