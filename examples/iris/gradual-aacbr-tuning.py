...
sweep_config = {
    ...
    "parameters": {
        "epochs": {"values": [1000, 3000, 4500]},
        "max_iters": {"values": [len(X_train)]},
        "use_symmetric_attacks": {"values": [False]},
        "lr": {"values": [3e-1, 3e-2, 3e-3]},
        "temperature": {"values": [1, 1e-1, 1e-2, 1e-3, 1e-4]},
        "use_blockers": {"values": [True]},
        "initialisation_method": {"values": ["normal", "He_uniform", "He_normal", "LeCun", "Xavier_uniform", "Xavier_normal"]},
        "alpha": {"values": [5e-2, 5e-3, 5e-3, 5e-5, 0]},
        "beta": {"values": [5e-2, 5e-3, 5e-3, 5e-5, 0]},
        "gamma": {"values": [5e-2, 5e-3, 5e-3, 5e-5, 0]},
    }
}
...
wandb.agent(sweep_id, function=main, count=1_000_000)